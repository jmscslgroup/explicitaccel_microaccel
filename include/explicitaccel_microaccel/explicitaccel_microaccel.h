...
struct B_explicitaccel_microaccel_T {
  ...
  SL_Bus_explicitaccel_microaccel_std_msgs_Float64 BusAssignment4;// '<S1>/Bus Assignment4' 
  SL_Bus_explicitaccel_microaccel_std_msgs_Float64 BusAssignment7;// '<S1>/Bus Assignment7' 
};
